...
botones.forEach((b) => {
    b.addEventListener("click", function () {
        ...
        texto.textContent = b.dataset.descripcion || "Actividad turística en Playa Ostional.";
        if (modalDetalle && b.dataset.detalle) {
            modalDetalle.href = b.dataset.detalle;
        }
        if (modalReserva && b.dataset.reserva) {
            modalReserva.href = b.dataset.reserva;
        }
